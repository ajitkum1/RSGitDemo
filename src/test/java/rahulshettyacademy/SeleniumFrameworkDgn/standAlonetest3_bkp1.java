...
public class standAlonetest3_bkp1 extends BaseTest {
	...
	public Object[][] getData()
	{
		...
		map.put("email", "ajitkum@abc.com");
		map.put("password", "@Ajit123");
		...
		return new Object[][] {{map},{map1}}; //two dimensional array
	}
